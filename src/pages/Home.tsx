...
export const HomePage = () => {
	return (
		<div className="mx-auto p-6 mt-5 rounded-lg w-2/3 text-center">
			...
			<div className="my-8 flex lg:flex-row flex-col gap-4 flex-auto justify-around lg:w-1/2 mx-auto">
				<Link to="/new">
